...
public class MLSchedulerClient {
    ...
    public DecideResponse decide(String simulationId, Map<String, Object> stateVector, 
        ...
        try {
            ...
            if (response != null) {
                ...
                if (data.containsKey("action") && data.get("action") instanceof Map<?, ?> actionMap) {
                    Map<String, Object> action = (Map<String, Object>) actionMap;
                    int nextBand = ((Number) action.get("next_band")).intValue();
                    Integer dwellTime = action.containsKey("dwell_time") && action.get("dwell_time") != null
                            ? ((Number) action.get("dwell_time")).intValue() : null;
                    String respModelId = data.containsKey("model_id") && data.get("model_id") != null
                            ? data.get("model_id").toString() : null;
                    String decisionId = data.containsKey("decision_id") && data.get("decision_id") != null
                            ? data.get("decision_id").toString() : "dec_" + System.currentTimeMillis();
    ...
    public String train(String algorithm, String scenario, Map<String, Object> hyperparams,
        ...
        try {
            ...
            if (response != null) {
                ...
                if (data.containsKey("job_id") && data.get("job_id") != null) {
    ...
    public Map<String, Object> getTrainingStatus(String jobId) {
        ...
        try {
            Map<String, Object> resp = restTemplate.getForObject("/internal/train/{jobId}/status", Map.class, jobId);
            if (resp != null) {
    ...
    public List<Map<String, Object>> listModels(String algorithm, Boolean active) {
        ...
        try {
            ...
            Object raw = restTemplate.getForObject(uri.toString(), Object.class);
            if (raw instanceof Map<?, ?> rawMap && rawMap.containsKey("data") && rawMap.get("data") instanceof List<?> list) {
