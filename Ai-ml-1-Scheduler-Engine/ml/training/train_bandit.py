...
def train_bandit(
    ...
    config = ContextualBanditConfig(num_bands=num_bands, seed=seed)
    agent = ContextualBanditAgent(config)
    
    run_dir = output_dir / "bandit" / run_id
    ...
    print(f"Starting Bandit training for {episodes} episodes...")
    ...
    for episode in range(episodes):
        ...
        for step in range(max_steps_per_episode):
            ...
            # Contextual Bandit uses the context *before* the action to update
